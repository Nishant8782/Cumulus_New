                ...
                {userData.memberships.map((membership) => {
                  ...
                  return (
                    <div key={membership._id} className="bg-gray-50 p-4 rounded-lg shadow-sm border">
                      ...
                      <p className="text-gray-700"><strong>Subscription Name:</strong> {subscription?.subscription_name || "N/A"}</p>
                      <p className="text-gray-700"><strong>Buying Date:</strong> {buyingDate ? buyingDate.toLocaleDateString() : "N/A"}</p>
                      <p className="text-gray-700"><strong>Plan Time:</strong> {membership.planTime || "N/A"}</p>
                      <p className="text-gray-700"><strong>Expiry Date:</strong> {expiryDate ? expiryDate.toLocaleDateString() : "N/A"}</p>
                      <p className="text-gray-700"><strong>Storage:</strong> {subscription?.features?.storage || "N/A"}</p>
                      <p className="text-gray-700"><strong>Encryption:</strong> {subscription?.features?.encryption || "N/A"}</p>
                    </div>
                  );
                })}
              </div>
